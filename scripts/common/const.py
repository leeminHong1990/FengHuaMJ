...
TIMER_TYPE_CREATE_ROOM                              = 13# 创建房间等待的timer
TIMER_TYPE_PREPARE                                  = 14# 准备时等待的timer
...
OP_PASS             = 0 # 过
OP_DRAW             = 1 # 摸牌
OP_FINAL_DRAW       = 2 # 最后一张
OP_DISCARD          = 3 # 打牌
OP_CHOW             = 4 # 吃
OP_PONG             = 5 # 碰
OP_KONG_WREATH     	= 6 # 杠花
OP_EXPOSED_KONG     = 7 # 明杠(直杠)
OP_CONCEALED_KONG   = 8 # 暗杠
OP_READY            = 9 # 听牌
OP_POST_KONG        = 10 # 放杠
OP_GET_KONG         = 11# 接杠
OP_DRAW_WIN         = 12# 自摸胡
OP_KONG_WIN         = 13# 抢杠胡
OP_WREATH_WIN  		= 14# 杠花胡
OP_GIVE_WIN  		= 15# 放炮胡
OP_FINAL_WIN  		= 16# 摸最后一张胡
OP_DRAW_END         = 17# 流局
OP_CUT  	        = 18# 杠后切牌
OP_RISK_KONG        = 19# 风险杠
...
CREATE_ROOM_WAIT_TIMER = 540 # 创建房间后等待的时间，单位为秒
